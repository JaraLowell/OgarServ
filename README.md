## Downloads
See the [releases](https://github.com/JaraLowell/OgarServ/releases) section for downloads (Current Version 1.5.5)
...
serverName: My url| The URL to display on the [Tracker](http://ogar.mivabe.nl/master) (leave empty will show ip:port, max 32char)
